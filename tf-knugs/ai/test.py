...
class LSTMModel:
    ...
    def preprocess(self):
        ...
        for i in range(self.num_time_steps, num_training_samples):
            ...
            self.y_train.append(self.scaled_data[i, self.close_column_index])  # use the close price as the label
        ...
        for i in range(num_training_samples, len(self.scaled_data)):
            ...
            self.y_test.append(self.scaled_data[i, self.close_column_index])  # use the close price as the label
