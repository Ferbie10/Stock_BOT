...
class CSVCleaner:
    ...
    def transform(self, output_file_path):
        ...
        self.df['bollinger_upper'] = self.df['20d_sma'] + (self.df['20d_std'] * 2)
        self.df['bollinger_lower'] = self.df['20d_sma'] - (self.df['20d_std'] * 2)
        ...
        self.df['%K'] = (self.df['close'] - self.df['14d_low']) / (self.df['14d_high'] - self.df['14d_low']) * 100
